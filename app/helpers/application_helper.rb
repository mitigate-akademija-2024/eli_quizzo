module ApplicationHelper
    ...
    def btn_class_small
      'inline-block rounded border border-indigo-600 bg-indigo-600 px-4 py-2 text-xs font-medium text-white hover:bg-transparent hover:text-indigo-600 focus:outline-none focus:ring active:text-indigo-500'
    end
